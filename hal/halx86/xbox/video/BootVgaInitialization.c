...
/* Ported into nxkrnl HAL; original cromwell GPL-2.0+ header preserved above. */
...
/* video_encoder / VIDEO_AV_MODE / xbox_ram / eeprom live in
 * xbox-video-support.c so they can be shared with VideoInitialization.c
 * etc. without multiple-definition errors. */
