...
/* Read only by the CODE_SEG("INIT") mode-calc helpers below; keep it in
 * the discardable INIT section instead of resident .rdata. */
static const conexant_video_parameter vidstda[] DATA_SEG("INITDATA") = {
